...
public class EntityAINearestAttackableTargetWithWhiteList<T extends EntityLivingBase> extends EntityAITarget {
    ...
    protected final EntityAINearestAttackableTargetWithWhiteList.Sorter sorter;
    ...
    public EntityAINearestAttackableTargetWithWhiteList(EntityCreature creature, Class<T> classTarget, int chance, boolean checkSight, boolean onlyNearby, @Nullable final Predicate <? super T > targetSelector) {
        ...
        this.sorter = new EntityAINearestAttackableTargetWithWhiteList.Sorter(creature);
        this.setMutexBits(1);
        this.targetEntitySelector = new Predicate<T>() {
            public boolean apply(@Nullable T p_apply_1_) {
                if (p_apply_1_ == null) {
                    ...
                    return !EntitySelectors.NOT_SPECTATING.apply(p_apply_1_) ? false : EntityAINearestAttackableTargetWithWhiteList.this.isSuitableTarget(p_apply_1_, false);
                }
            }
        };
    }
