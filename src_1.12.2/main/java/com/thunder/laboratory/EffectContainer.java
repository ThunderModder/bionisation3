...
import com.thunder.laboratory.samples.symbiont.*;
...
public class EffectContainer {
    ...
    private EffectContainer(){
       ...
       effects.add(new SymbiontOfPower());
       effects.add(new SymbiontOfResistance());
       effects.add(new SymbiontOfMobility());
       effects.add(new SymbiontOfTrueVision());
       effects.add(new SymbiontOfMagicAffinity());
       effects.add(new SymbiontOfWitheringEye());
       effects.add(new SymbiontOfImmunity());
       effects.add(new SymbiontOfBlood());
       effects.add(new SymbiontOfHealth());
       effects.add(new SymbiontOfEffectPower());
       effects.add(new SymbiontOfHealthyStomach());
       effects.add(new SymbiontOfCreeperSoul());
       effects.add(new SymbiontOfBlazeHeart());
       effects.add(new SymbiontOfSouls());
       effects.add(new SymbiontOfGolemPower());
       effects.add(new SymbiontOfWaterAffinity());
       effects.add(new SymbiontOfVampirism());
    }
