...
public class MyceliumParticle extends Particle {

    public MyceliumParticle(ResourceLocation location, World worldIn, double posXIn, double posYIn, double posZIn, double motionX, double motionY, double motionZ) {
