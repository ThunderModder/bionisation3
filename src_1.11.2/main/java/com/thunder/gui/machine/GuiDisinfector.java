...
public class GuiDisinfector extends GuiContainer {

    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(Information.MOD_ID + ":textures/gui/machine/gui_disinfector.png");
    private final InventoryPlayer playerInventory;
    private final IInventory machine;

    public GuiDisinfector(InventoryPlayer playerInv, IInventory inventory){
        super(new ContainerDisinfector(playerInv, inventory));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY){
        ...
        if (TileDisinfector.isProcessing(this.machine)){
            ...
            this.drawTexturedModalRect(i + 7, j + 16, 176, 14, 7, 62 - i1);
        }else
            this.drawTexturedModalRect(i + 7, j + 16, 176, 14, 7, 62);
    }
