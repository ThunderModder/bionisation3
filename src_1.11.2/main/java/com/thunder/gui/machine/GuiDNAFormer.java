...
public class GuiDNAFormer extends GuiContainer {

    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation(Information.MOD_ID + ":textures/gui/machine/gui_dnaformer.png");
    private final InventoryPlayer playerInventory;
    private final IInventory machine;

    public GuiDNAFormer(InventoryPlayer playerInv, IInventory inventory){
        super(new ContainerDNAFormer(playerInv, inventory));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY){
        ...
        if (TileDNAFormer.isProcessing(this.machine)){
