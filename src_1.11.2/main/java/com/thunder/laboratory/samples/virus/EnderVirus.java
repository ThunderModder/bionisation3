...
import static com.thunder.util.Constants.ID_ENDER_VIRUS;
    ...
    public void performPlayer(Event event, EntityPlayer player, EventType type, IBioPlayer cap) {
        ...
        if(type == EventType.HURT){
            ...
            if(source.getSourceOfDamage() instanceof EntityLivingBase)
                Utilities.addEffectToLiving(new EnderVirus(STANDART_VIRUS_DURATION, 2), (EntityLivingBase)source.getSourceOfDamage());
        }
